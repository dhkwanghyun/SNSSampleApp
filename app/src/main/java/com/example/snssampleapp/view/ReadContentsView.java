package com.example.snssampleapp.view;
...
public class ReadContentsView extends LinearLayout {
    ...
    public void setPostInfo(PostInfo postInfo){
        TextView creatAtTextView = findViewById(R.id.createAtTextView);
        creatAtTextView.setText(new SimpleDateFormat("yyyy-MM-dd", Locale.getDefault()).format(postInfo.getCreatedAt()));
