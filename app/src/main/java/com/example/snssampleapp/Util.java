...
public class Util {
    ...
    public static boolean isStorageUrl(String url){
        return Patterns.WEB_URL.matcher(url).matches() && url.contains("https://firebasestorage.googleapis.com/v0/b/android-91550.appspot.com/o/posts");
    }
    ...
    public static String storageUrlToType(String url){
        Log.d("aaaaaa", "storageUrlToType: "+URLConnection.guessContentTypeFromName(url.split("\\?")[0].split("\\.")[url.split("\\.").length-1]));
