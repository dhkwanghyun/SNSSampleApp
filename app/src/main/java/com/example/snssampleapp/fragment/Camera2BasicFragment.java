...
import com.example.snssampleapp.view.AutoFitTextureView;
...
public class Camera2BasicFragment extends Fragment
    ...
    private int facingId = 0; //카메라 전,후면 아이디 값
    private boolean mAutoFocusSupported = true; //자동 포커스 체크
    ...
    private static class ImageUpLoader implements Runnable {
        ...
        public void run() {
            ...
            final StorageReference mountainsRef = storageRef.child("users/"+firebaseUser.getUid()+"profileImage.png");
